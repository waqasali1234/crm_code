                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-4 col-sm-12">
                      ...
                      <span ><span class="text-danger"></span>  GSTIN
                        ...
                        <div class="input-group">
                            <input type="text" name="gstin" class="form-control form-control-sm "  value="{{@$lead->gstin}}" />
                            <span class="text text-danger"></span>
                        </div>
                    </div>
                      <div class="col-md-4 col-sm-12">
                      <span ><span class="text-danger"></span>  Landline
                        ...
                        <div class="input-group">
                            <input type="text" name="landline" class="form-control form-control-sm "  value="{{@$lead->landline}}" />
                            <span class="text text-danger"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 col-sm-12">  
                      ...
                      <div class="col-md-4 col-sm-12">
                          <div class="form-group">
                              ...
                              <input type="datetime-local" name="callon"   value="{{@$lead->callon}}" class="form-control form-control-sm " />
                          </div>
                          <span class="text text-danger"></span>
                      </div>
