            ...
            <div class="tab-content" id="custom-tabs-three-tabContent">
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                  <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control form-control-sm " placeholder="{{__('Enter Lead\'s Company Name')}}"
                      />
                  </div>
                  <span class="text text-danger"></span>
                </div>
              ...
              <div class="row mt-2">
                ...
                <div class="col-md-4 col-sm-12">
                  ...
                  <div class="col-md-4 col-sm-12">
                  <span ><span class="text-danger"></span>  GSTIN

                  </span>

                    <div class="input-group">
                        <input type="text" name="gstin" class="form-control form-control-sm " placeholder="{{__('Enter gstin')}}" />
                        <span class="text text-danger"></span>
                    </div>
                </div>
                  <div class="col-md-4 col-sm-12">
                  <span ><span class="text-danger"></span>  Landline

                  </span>

                    <div class="input-group">
                        <input type="text" name="landline" class="form-control form-control-sm " placeholder="{{__('Enter landline')}}" />
                        <span class="text text-danger"></span>
                    </div>
                </div>
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8 col-sm-12">
                  ...
                  <div class="col-md-4 col-sm-12">
                      <div class="form-group">
                          <span ><span class="text-danger"></span> {{__(' Call On')}}</span>
