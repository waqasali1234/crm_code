            ...
            <div class="col-md-9">
                <div class="card card-secondary">
                    <div class="card-header bg-gray">
                        <span class="float-left">{{__('Manage Quotation')}}</span>
                        @php
                            $relation = 'Customer';
                        @endphp
                        <a class="card-title bg-primary pl-2 pr-2 rounded float-right" href="{{url('proposal/create/'.$relation.'/'.$customer->id)}}" id="addNewNote" >{{__('New Quotation')}}</a>
                    </div>
                    <div class="card-body">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-danger">#{{@$proposal->id}} |
                                                            {{__('Quotation')}} - {{@$proposal->subject}} </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="">{{__('Quotation Start Date')}}</label>
                                                                    <input type="text"
                                                                        class="form-control form-control-sm"
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="">{{__('Quotation End Date')}}</label>
                                                                    <input type="text"
                                                                        class="form-control form-control-sm"
...
<div class="modal fade" id="addproposal" tabindex="-1" role="dialog" aria-labelledby="addproposalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addproposalLabel">{{__('Add Quotation')}}</h5>
