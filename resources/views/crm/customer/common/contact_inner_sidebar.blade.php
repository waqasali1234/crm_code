        ...
        <div class="card-body">
            <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                @if ($route_active == 'customer_proposal')
                    <a class="nav-link active" href="{{url('/customer/'.$customer->id.'/proposals')}}">{{__('Quotations')}}</a>
                @else
                    <a class="nav-link" href="{{url('/customer/'.$customer->id.'/proposals')}}">{{__('Quotations')}}</a>
                @endif
