...
{{--            <-----------starting footer logo--------->--}}
            <form action="{{url('office/general_setting/logo/store1')}}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header  bg-gray">
                                <h4 class="card-title"> {{__('Company Footer Logo')}}</h4>
                            </div>
                            <div class="card-body bg-light-gray">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file1" id="featured_image" required>
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file2" id="featured_image" required>
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file3" id="featured_image" required>
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file4" id="featured_image" required>
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file5" id="featured_image" required>
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">* </span>{{__('Select Image File to upload')}} </label>
                                    <div class="input-group">
                                        <input type="file" name="logo_file6" id="featured_image" required>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body bg-light-gray">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="terms" id="" cols="30" rows="9"  class="form-control form-control-sm" required value="{{@$terms->field_value}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="terms1" id="" cols="30" rows="9"  class="form-control form-control-sm" required value="{{@$terms1->field_value}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="terms2" id="" cols="30" rows="9"  class="form-control form-control-sm" required value="{{@$terms2->field_value}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="terms3" id="" cols="30" rows="9"  class="form-control form-control-sm" required value="{{@$terms3->field_value}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="terms4" id="" cols="30" rows="9"  class="form-control form-control-sm" required value="{{@$terms4->field_value}}">
                                    </div>
                                </div>
