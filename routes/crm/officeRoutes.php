...
Route::group(['prefix'=>'/office','middleware'=>['auth']], function(){
    ...
    Route::get('/fullcalender', [GeneralSettingsController::class, 'calendar'])->middleware(['can:view-office', 'password.confirm']);
    Route::post('/fullcalenderAjax', [GeneralSettingsController::class, 'ajax'])->middleware(['can:view-office', 'password.confirm']);
    Route::post('/general_setting/logo/store', [GeneralSettingsController::class, 'store'])->middleware('can:create-office');
    Route::post('/general_setting/logo/store1', [GeneralSettingsController::class, 'store1'])->middleware('can:create-office');
