...
class ProposalController extends Controller
{
    ...
    function terms_details(){
        $terms_details = [];
        $terms1 =DB::table('terms')->select('term1')->get();
        array_push($terms_details, $terms1);
        $terms2 =DB::table('terms')->select('term2')->get();
        array_push($terms_details, $terms2);
        $terms3 =DB::table('terms')->select('term3')->get();
        array_push($terms_details, $terms3);
        $terms4 =DB::table('terms')->select('term4')->get();
        array_push($terms_details, $terms4);
        $terms5 =DB::table('terms')->select('term5')->get();
        array_push($terms_details, $terms5);
        $terms6 =DB::table('terms')->select('term6')->get();
        array_push($terms_details, $terms6);
    ...
    public function show($proposal){
        ...
        return view('crm.proposal.proposal_pdf', compact([
            'logo',
            'company_name',
            'company_address',
            'company_city',
    ...
    public function proposal_pdf(Proposal $proposal){
       ...
       $products = $proposal->proposalProducts;
        $dt = Carbon::parse($proposal->proposal_date);
        $dttt = Carbon::parse($proposal->open_till_date);
        $dtt = $dttt->diffInDays($dt);
        $logo1 = SingleRowData::where('field_name','logo_file1')->first();
        $logo2 = SingleRowData::where('field_name','logo_file2')->first();
        $logo3 = SingleRowData::where('field_name','logo_file3')->first();
        $logo4 = SingleRowData::where('field_name','logo_file4')->first();
        $logo5 = SingleRowData::where('field_name','logo_file5')->first();
        $logo6 = SingleRowData::where('field_name','logo_file6')->first();
...
//dd($terms1);
      ...
      $pdf = PDF::loadView('crm.proposal.proposal_pdf', compact('proposal','company_details','products','dt','dtt','terms','logo','terms1','terms2','terms3','terms4','terms_details','logo1','logo2','logo3','logo4','logo5','logo6'));
